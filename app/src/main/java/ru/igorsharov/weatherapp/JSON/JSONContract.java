...
interface JSONContract {
    ...
    String OPENWEATHER_API_URL = "https://api.openweathermap.org/data/2.5/";
    String OPENWEATHER_TODAY = "weather?";
    String OPENWEATHER_FORECAST = "forecast?";
    String OPENWEATHER_API_KEY = "f7e04c998fc34bed211349ba89c5d7e7";
    String OPEN_WEATHER_KEYS[] = {"appid", "lang", "lon", "lat", "units"};
    String UNITS = "metric";
